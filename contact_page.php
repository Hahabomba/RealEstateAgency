<div id="container">
  ...
  <form action="display_contact_results.php" method="post" id="contact_form">
    <div class="name">
    ...
    <div class="subject">
      ...
      <select placeholder="Subject line" name="subject" id="subject_input" required>
        ...
        <option>I'd like to make an appointment</option>
        <option>I'd like to make a correction</option>
